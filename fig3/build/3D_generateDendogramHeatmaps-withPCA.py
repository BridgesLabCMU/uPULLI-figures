...
dataPath = str(config.input('reimaging/collapsedWide.parquet'))                 # raw feature matrix (KiltHub; see build/README.md)
indexPath = str(config.input('reimaging/geneIndex.csv'))               # gene annotations (KiltHub)
