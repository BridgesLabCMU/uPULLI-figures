...
Writes: figures/3Cbottom_centroidsByLocus.{png,svg} (+ _byChr + colorbars)
"""
import sys
...
outBase = outDir / '3Cbottom_centroidsByLocus'
outBase2 = outDir / '3Cbottom_centroidsByLocus_byChr'
