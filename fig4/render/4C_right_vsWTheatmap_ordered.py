"""fig4 render: Panel 4C right (reordered ΔbioD/ΔpdhE2/ΔmanA) - clean-deletion feature heatmap.
...
H = pd.read_csv(config.TABLES / 'cleanDel_vsWT_horizontal_matrix.csv', index_col=0).reindex(['BioD', 'PdhE2', 'ManA'])
...
out = config.ensure(config.FIGURES) / '4C_right_vsWTheatmap_ordered'
