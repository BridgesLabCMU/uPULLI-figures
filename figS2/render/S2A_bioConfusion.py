#!/usr/bin/env python3
"""figS2 render: Panel S2A - biomass-only Random-Forest confusion matrix.

Renders FROM the bundled mean row-normalized confusion matrix. Balanced accuracy (title) = mean of the
diagonal. Same style as Fig 2E (all features) — this is the biomass-only slice.

Reads:  data/bio_confusion_cv.csv
Writes: figures/S2A_bioConfusion.{png,svg}
"""
import sys
...
CSV, TITLE, STEM = 'bio_confusion_cv.csv', 'Biofilm Biomass', 'S2A_bioConfusion'
